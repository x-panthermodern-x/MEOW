...
def record_calculator(records, sell_price, print_cost, mail_order_wage, records_per_day_range, packaging_cost, mail_order_assistants, shipping_per_unit, weight_per_record):
    ...
    total_cost = total_print_cost + total_packaging_cost + mail_order_total_wage + shipping_cost

    # Calculate total profit
    total_profit = total_revenue - total_cost

    return total_revenue, total_print_cost, total_records_per_day, days_needed, mail_order_total_wage, total_packaging_cost, shipping_cost, total_cost, total_profit, records_per_assistant

# Variables
records = 2000 #Total Amount of record your printing
sell_price = 25 #Price you are selling your records at
unit_cost = 6 #Average cost per vinyl unit
mail_order_assistants = 2 #How many people you are hiring to help you out
...
#NOT USED / it was not as accurate but can be used for additional calculations
shipping_rate = 0.05  # $0.05 per kg per 1,000 km
distance = 4488  # Distance from Italy to Los Angeles in km
weight_per_record = 0.2 #Kilograms
total_weight = records * weight_per_record
shipping_weight_cost = total_weight * shipping_rate * (distance / 1000)
...
total_revenue, total_print_cost, total_records_per_day, days_needed, mail_order_total_wage, total_packaging_cost, shipping_cost, total_cost, total_profit, records_per_assistant = record_calculator(records, sell_price, unit_cost, mail_order_wage, records_per_day_range, packaging_cost, mail_order_assistants, shipping_per_unit, weight_per_record)
...
for _ in range(num_runs):
    _, _, _, _, _, _, _, total_cost, total_profit, _ = record_calculator(records, sell_price, unit_cost, mail_order_wage, records_per_day_range, packaging_cost, mail_order_assistants, shipping_per_unit, weight_per_record)
